                ...
                <Form >
                    ...
                    <Stack direction="horizontal" gap={1}>
                        ...
                        <div className=' ms-auto'>
                            <Button className={work_sans.className} href="/" variant='person1' style={{ borderradius: '18px', color: '#FFFFFF', fontWeight: 'bolder', fontSize: '19px', padding: '15px', width: '200px' }}>
                                Entrar
                            </Button>
                        </div>
                    </Stack>
